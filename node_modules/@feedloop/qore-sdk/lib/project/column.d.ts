...
export declare type Columns = {
    ...
    lookup: {
        value(): string | string[] | number | number[] | boolean | boolean[] | RelationValue | RelationValue[] | null;
    };
    relation: {
...
export declare type Column<T extends FieldType = FieldType> = Columns[T];
export {};
